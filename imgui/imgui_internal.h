...
//#endif
    ...
    IMGUI_API bool          CustomBeginChildEx(const char* name, const char* description, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);
    ...
    IMGUI_API bool          Tab(bool selectable, const char* label, const ImVec2& size_arg);
