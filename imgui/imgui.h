...
namespace ImGui
{
    ...
    IMGUI_API bool          CustomBeginChild(const char* str_id, const char* description, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
    IMGUI_API bool          CustomBeginChild(ImGuiID id, const char* description, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
    ...
    IMGUI_API void          ProgressBar(ImGuiID id, float fraction, const ImVec2& size_arg = ImVec2(-FLT_MIN, 0), const char* overlay = NULL);
    ...
    IMGUI_API void          CustomEndChildFrame();
